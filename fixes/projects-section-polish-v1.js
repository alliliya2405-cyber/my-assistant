...
/* Projects section polish v1
   Route markers and protection from the generic collapse layer.
   No state mutation or business-logic changes. */
(() => {
  ...
  function openWorkCards() {
    ...
    content.querySelectorAll('.global-collapse-controls').forEach(el => el.remove());
    content.querySelectorAll('.global-collapse-bar').forEach(el => el.remove());
